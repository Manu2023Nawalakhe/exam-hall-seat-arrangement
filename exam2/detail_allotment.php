...
<body>
    ...
    $sql = "SELECT * FROM exams WHERE date= '" . $date . "'  AND title= '" . $title . "' AND subject= '" . $subject . "' AND floor= '" . $floor . "' AND room= '" . $room . "'";
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td style="text-align:center"> <?php echo $row["desk_number"] ?></td>
                    </tr>
